...
const GALLERY_IMAGE_URLS = [
  new URL("@/components/assets/gallery-1.webp", import.meta.url).href,
  new URL("@/components/assets/gallery-2.webp", import.meta.url).href,
  new URL("@/components/assets/gallery-3.webp", import.meta.url).href,
  new URL("@/components/assets/gallery-4.webp", import.meta.url).href,
  new URL("@/components/assets/gallery-5.webp", import.meta.url).href,
] as const;
...
export function Gallery({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // sRGBEncoding removed in r152+, use SRGBColorSpace
